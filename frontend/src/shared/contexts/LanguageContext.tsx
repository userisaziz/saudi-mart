...
const translations = {
  en: {
    ...
    // Admin Logs
    'admin.logs.title': 'System & Activity Logs',
    'admin.logs.subtitle': 'Monitor and track all system and user activities',
    'admin.logs.exportLogs': 'Export Logs',
    'admin.logs.loggingSettings': 'Logging Settings',
    'admin.logs.totalActivities': 'Total Activities',
    'admin.logs.failedActivities': 'Failed Activities',
    'admin.logs.highAlerts': 'High Alerts',
    'admin.logs.systemErrors': 'System Errors',
    'admin.logs.last24Hours': 'Last 24 hours',
    'admin.logs.needReview': 'Need review',
    'admin.logs.highPriority': 'High priority',
    'admin.logs.criticalAndErrors': 'Critical and errors',
    'admin.logs.activityLog': 'Activity Log',
    'admin.logs.systemLog': 'System Log',
    'admin.logs.securityEvents': 'Security Events',
    'admin.logs.searchActivities': 'Search activities...',
    'admin.logs.searchSystemLogs': 'Search system logs...',
    'admin.logs.resourceType': 'Resource Type',
    ...
    'admin.logs.authentication': 'Authentication',
    'admin.logs.payment': 'Payment',
    'admin.logs.severity': 'Severity',
    'admin.logs.allLevels': 'All Levels',
    'admin.logs.low': 'Low',
    'admin.logs.medium': 'Medium',
    'admin.logs.high': 'High',
    'admin.logs.critical': 'Critical',
    'admin.logs.level': 'Level',
    'admin.logs.info': 'Info',
    'admin.logs.warning': 'Warning',
    'admin.logs.error': 'Error',
    'admin.logs.userName': 'User',
    ...
    'admin.logs.component': 'Component',
    'admin.logs.message': 'Message',
    'admin.logs.responseTime': 'Response Time',
    'admin.logs.activityDetails': 'Activity Details',
    'admin.logs.systemLogDetails': 'System Log Details',
    'admin.logs.networkInfo': 'Network Info',
    'admin.logs.location': 'Location',
    'admin.logs.details': 'Details',
    'admin.logs.userAgent': 'User Agent',
    'admin.logs.requestId': 'Request ID',
    'admin.logs.statusCode': 'Status Code',
    'admin.logs.close': 'Close',
    'admin.logs.success': 'Success',
    'admin.logs.failed': 'Failed',
    'admin.logs.admin': 'Admin',
    'admin.logs.seller': 'Seller',
    'admin.logs.customer': 'Customer',
    'admin.logs.resolved': 'Resolved',
    'admin.logs.open': 'Open',
    'admin.logs.viewDetails': 'View Details',
    'admin.logs.markAsResolved': 'Mark as Resolved',
    'admin.logs.suspiciousActivity': 'Suspicious Activity',
    ...
    'profile.completeProfileDesc': 'Complete your profile to increase trust with customers',
    'profile.basicInfo': 'Basic Info',
    'profile.verification': 'Verification',
    'profile.productImages': 'Product Images',
    'profile.productImagesDesc': 'Add more product images to increase trust score by 8%',
    'profile.companyInformation': 'Company Information',
    ...
    'profile.conversionRate': 'Conversion Rate',
    'profile.profileSections': 'Profile Sections',
    'profile.profileSectionsDesc': 'Manage and update different sections of your profile',
    'profile.companyInfoSection': 'Company Information',
    'profile.companyInfoSectionDesc': 'Basic company and business details',
    'profile.documentsSection': 'Documents',
    'profile.documentsSectionDesc': 'Commercial registration and required documents',
    'profile.contactsSection': 'Contacts',
    'profile.contactsSectionDesc': 'Contact information and responsible persons',
    'profile.businessHoursSection': 'Business Hours',
    'profile.businessHoursSectionDesc': 'Working hours and availability',
    'profile.lastActivity': 'Last Activity',
    'profile.memberSince': 'Member Since',

    'profile.documentStatus': 'Document Status',
    'profile.commercialRegistration': 'Commercial Registration',
    'profile.taxCertificate': 'Tax Certificate',
    ...
    'profile.manageDocuments': 'Manage Documents',
    'profile.recentActivity': 'Recent Activity',
    'profile.companyInfoUpdated': 'Company information updated',
    'profile.hoursAgo': 'hours ago',
    'profile.newOrderReceived': 'New order received',
    'profile.productCatalogUpdated': 'Product catalog updated',
    'profile.dayAgo': 'day ago',
    'profile.premiumSubscriptionRenewed': 'Premium subscription renewed',
    'profile.daysAgo': 'days ago',
    'profile.newDocumentsUploaded': 'New documents uploaded',
  ...
  ar: {
    ...
    // Admin Logs
    'admin.logs.title': 'سجلات النظام والنشاط',
    'admin.logs.subtitle': 'مراقبة وتتبع جميع أنشطة النظام والمستخدمين',
    'admin.logs.exportLogs': 'تصدير السجلات',
    'admin.logs.loggingSettings': 'إعدادات التسجيل',
    'admin.logs.totalActivities': 'إجمالي الأنشطة',
    'admin.logs.failedActivities': 'أنشطة فاشلة',
    'admin.logs.highAlerts': 'تنبيهات عالية',
    'admin.logs.systemErrors': 'أخطاء النظام',
    'admin.logs.last24Hours': 'آخر 24 ساعة',
    'admin.logs.needReview': 'تحتاج مراجعة',
    'admin.logs.highPriority': 'أولوية عالية',
    'admin.logs.criticalAndErrors': 'حرجة وأخطاء',
    'admin.logs.activityLog': 'سجل الأنشطة',
    'admin.logs.systemLog': 'سجل النظام',
    'admin.logs.securityEvents': 'الأحداث الأمنية',
    'admin.logs.searchActivities': 'البحث في الأنشطة...',
    'admin.logs.searchSystemLogs': 'البحث في سجلات النظام...',
    'admin.logs.resourceType': 'نوع المورد',
    'admin.logs.allTypes': 'جميع الأنواع',
    'admin.logs.user': 'مستخدم',
    'admin.logs.product': 'منتج',
    'admin.logs.order': 'طلب',
    'admin.logs.category': 'فئة',
    'admin.logs.authentication': 'مصادقة',
    'admin.logs.payment': 'دفع',
    'admin.logs.severity': 'الخطورة',
    'admin.logs.allLevels': 'جميع المستويات',
    'admin.logs.low': 'منخفضة',
    'admin.logs.medium': 'متوسطة',
    'admin.logs.high': 'عالية',
    'admin.logs.critical': 'حرجة',
    'admin.logs.level': 'المستوى',
    'admin.logs.info': 'معلومات',
    'admin.logs.warning': 'تحذير',
    'admin.logs.error': 'خطأ',
    'admin.logs.userName': 'المستخدم',
    'admin.logs.activity': 'النشاط',
    'admin.logs.resource': 'المورد',
    'admin.logs.status': 'الحالة',
    'admin.logs.time': 'الوقت',
    'admin.logs.actions': 'الإجراءات',
    'admin.logs.component': 'المكون',
    'admin.logs.message': 'الرسالة',
    'admin.logs.responseTime': 'وقت الاستجابة',
    'admin.logs.activityDetails': 'تفاصيل النشاط',
    'admin.logs.systemLogDetails': 'تفاصيل سجل النظام',
    'admin.logs.networkInfo': 'معلومات الشبكة',
    'admin.logs.location': 'الموقع',
    'admin.logs.details': 'التفاصيل',
    'admin.logs.userAgent': 'متصفح المستخدم',
    'admin.logs.requestId': 'معرف الطلب',
    'admin.logs.statusCode': 'رمز الحالة',
    'admin.logs.close': 'إغلاق',
    'admin.logs.success': 'نجح',
    'admin.logs.failed': 'فشل',
    'admin.logs.admin': 'مدير',
    'admin.logs.seller': 'بائع',
    'admin.logs.customer': 'عميل',
    'admin.logs.resolved': 'تم الحل',
    'admin.logs.open': 'مفتوح',
    'admin.logs.viewDetails': 'عرض التفاصيل',
    'admin.logs.markAsResolved': 'تعيين كمحلول',
    ...
    'profile.orders': 'طلبات',
    'profile.settings': 'الإعدادات',
    'profile.overview': 'نظرة عامة',
    'profile.statistics': 'الإحصائيات',
    'profile.documents': 'المستندات',
    'profile.activity': 'النشاط',
    'profile.profileCompleteness': 'مدى اكتمال الملف الشخصي',
    'profile.completeProfileDesc': 'أكمل ملفك الشخصي لزيادة الثقة مع العملاء',
    'profile.basicInfo': 'المعلومات الأساسية',
    'profile.verification': 'التحقق',
    'profile.productImages': 'صور المنتجات',
    'profile.productImagesDesc': 'أضف المزيد من صور المنتجات لزيادة نقاط الثقة بنسبة 8%',
    'profile.companyInformation': 'معلومات الشركة',
    ...
    'profile.excellent': 'ممتاز',
    'profile.responseTime': 'وقت الاستجابة',
    'profile.good': 'جيد',
    'profile.rating': 'التقييم',
    'profile.reviews': 'تقييمات',
    'profile.conversionRate': 'معدل التحويل',
    'profile.profileSections': 'أقسام الملف الشخصي',
    'profile.profileSectionsDesc': 'إدارة وتحديث أقسام مختلفة من ملفك الشخصي',
    'profile.companyInfoSection': 'معلومات الشركة',
    'profile.companyInfoSectionDesc': 'تفاصيل الشركة والعمل الأساسية',
    'profile.documentsSection': 'المستندات',
    'profile.documentsSectionDesc': 'السجل التجاري والمستندات المطلوبة',
    'profile.contactsSection': 'جهات الاتصال',
    'profile.contactsSectionDesc': 'معلومات الاتصال والأشخاص المسؤولين',
    'profile.businessHoursSection': 'ساعات العمل',
    'profile.businessHoursSectionDesc': 'ساعات العمل والتوفر',
    'profile.lastActivity': 'آخر نشاط',
    'profile.memberSince': 'عضو منذ',
    'profile.documentStatus': 'حالة المستندات',
    'profile.commercialRegistration': 'السجل التجاري',
    'profile.taxCertificate': 'شهادة الضريبة',
    'profile.bankDetails': 'تفاصيل البنك',
    'profile.identityVerification': 'التحقق من الهوية',
    'profile.approved': 'موافق عليه',
    'profile.required': 'مطلوب',
    'profile.manageDocuments': 'إدارة المستندات',
    'profile.recentActivity': 'النشاط الأخير',
    'profile.companyInfoUpdated': 'تم تحديث معلومات الشركة',
    'profile.hoursAgo': 'ساعات مضت',
    'profile.newOrderReceived': 'تم استلام طلب جديد',
    'profile.productCatalogUpdated': 'تم تحديث كتالوج المنتجات',
    'profile.dayAgo': 'يوم مضى',
    'profile.premiumSubscriptionRenewed': 'تم تجديد الاشتراك المميز',
    'profile.daysAgo': 'أيام مضت',
    'profile.newDocumentsUploaded': 'تم رفع مستندات جديدة',
    'profile.weekAgo': 'أسبوع مضى',
  },
};
